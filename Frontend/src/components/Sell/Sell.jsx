              ...
              <div className="flex flex-col items-center">
                {images.map((image, index) => (
                  <div key={index} className="mb-2 text-center">
                    <p className="text-lg text-gray-500 dark:text-white capitalize font-bold ">{image.name}</p>
                    <p className="text-xs text-gray-500 dark:text-white">{(image.size / 1024).toFixed(2)} KB</p>
